    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, VerificarToken verificarToken) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/usuario/email/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/votos/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/paut/id/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/pauta/assunto/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.GET, "/usuario/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/votos/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/pauta/**").hasAnyRole("ADMIN", "MANAGER")
